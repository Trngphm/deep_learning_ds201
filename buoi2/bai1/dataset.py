...
#     data = {
#         "image": torch.tensor(data["image"]).unsqueeze(1),
...
#     def __init__(self, image_path, label_path, image_size=(32, 32)):
#         images = idx2numpy.convert_from_file(image_path)
#         labels = idx2numpy.convert_from_file(label_path)

#         self._data = [{
#             "image": resize(np.array(image, dtype=np.float32), image_size, anti_aliasing=True) / 255.0,  # normalize
#             "label": label
