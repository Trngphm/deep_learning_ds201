...
device = "cpu"
MODEL_TYPE = "mlp3" # choose mlp1 or mlp3
...
if __name__ == "__main__":
    ...
    if MODEL_TYPE == "mlp1":
        ...
        model = Perceptron_3_layer(image_size=(28, 28), num_labels=10).to(device)
    else:
        raise ValueError("MODEL_TYPE phải là 'mlp1' hoặc 'mlp3'")
